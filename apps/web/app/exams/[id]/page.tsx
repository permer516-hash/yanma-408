          ...
          <>
            <header className="app-page-header mt-4 overflow-hidden">
              ...
              <div className="mt-4 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                ...
                <Link
                  className="app-button-primary inline-flex items-center justify-center"
            ...
            <section className="app-panel mt-5 overflow-hidden">
              <div className="app-table-header px-5 py-3">
                题目清单
              </div>
              {paper.questions.map((question, index) => (
                <Link
                  className="app-row grid gap-3 px-5 py-4 lg:grid-cols-[56px_1fr_88px_88px]"
            ...
            <section className="mt-5 grid gap-5 lg:grid-cols-[1fr_1fr]">
              <div className="app-panel p-5">
                <h2 className="app-section-title">作答历史</h2>
                <div className="mt-4 space-y-3">
                  {history.length === 0 && <p className="text-sm text-slate-500">暂无交卷记录。</p>}
                  {history.slice(0, 5).map((attempt) => (
                    <Link
                      className="block rounded-md border border-slate-200 bg-slate-50/50 p-3 text-sm hover:border-teal-700 hover:bg-white"
              ...
              <div className="app-panel p-5">
                <h2 className="app-section-title">最近两次对比</h2>
